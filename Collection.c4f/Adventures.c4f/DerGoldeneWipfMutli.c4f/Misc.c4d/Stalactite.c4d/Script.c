...
func Initialize() {
  ...
  ScheduleCall(this(),"Check2",1,0);
}

func Check2()
{
 ScheduleCall(this(),"Check2",2,0);
//if(GetOCF()!=OCF_InFree())Hit();
//if(GetMaterial(0,19))if(GetMaterial(0,19)!=Material("Tunnel"))if(GetMaterial(0,19)!=Material("Tunnel2"))if(GetMaterial(0,19)!=Material("Wall"))Hit();
 if(GBackSolid(0,19))Hit();
 }
