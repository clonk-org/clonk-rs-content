...
private func Execute()
{
 ...
 PlrMessage("$MsgRelaunchTime$", iPlr, (2000-GetActTime()) / 35 / 60, (2000-GetActTime()) / 35 % 60);
}
...
global func SetViewCursor(a,b,c,d,e,f,g,h,i,j) { return(_inherited(a,b,c,d,e,f,g,h,i,j)); }
global func ScoreboardCol(a,b,c,d,e,f) { return(_inherited(a,b,c,d,e,f)); }
