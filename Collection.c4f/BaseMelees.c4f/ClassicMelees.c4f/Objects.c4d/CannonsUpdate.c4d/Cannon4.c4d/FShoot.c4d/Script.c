...
global func CreateFireShoot(object pCaster, int iTime, int iX, int iY, int iRot, int iRotSpeed, int iExtraSpeed)
  {
  return(CreateObject(_FSH,0,0,GetOwner(pCaster))->_FSH::Activate(pCaster,iTime, iX, iY, iRot, iRotSpeed, iExtraSpeed));
  }
