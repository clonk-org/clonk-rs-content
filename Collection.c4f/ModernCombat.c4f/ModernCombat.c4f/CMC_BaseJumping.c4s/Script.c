...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_BaseJumping.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 770, 1490, -1)->Set(1,1);
  CreateObject(SBBA, 1450, 800, -1)->Set(0,1);
  CreateObject(SBBA, 1490, 920, -1)->Set(0,1);
  CreateObject(SBBA, 1501, 1540, -1)->Set(0,1);
  CreateObject(SBBA, 1580, 1540, -1)->Set(1,1);
  CreateObject(SBBA, 1590, 920, -1)->Set(1,1);
  CreateObject(SBBA, 1630, 800, -1)->Set(1,1);
  CreateObject(SBBA, 2311, 1490, -1)->Set(0,1);
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 735, 1570, -1)->Set(ABOX);
  CreateObject(AMCT, 1400, 940, -1)->Set(ABOX);
  CreateObject(AMCT, 2345, 1570, -1)->Set(ABOX);

  //Versorgungskisten (Gewehrgranaten)
  CreateObject(AMCT, 1470, 1570, -1)->Set(GBOX);
  CreateObject(AMCT, 1680, 940, -1)->Set(GBOX);

  //Versorgungskisten (Raketen)
  CreateObject(AMCT, 600, 250, -1)->Set(MBOX);
  CreateObject(AMCT, 1610, 1570, -1)->Set(MBOX);
  CreateObject(AMCT, 2480, 250, -1)->Set(MBOX);

  //Versorgungskisten (APW)
  CreateObject(AMCT, 810, 440, -1)->Set(ATWN);
  CreateObject(AMCT, 2270, 440, -1)->Set(ATWN);

  //Versorgungskiste (Dragnin)
  CreateObject(AMCT, 1540, 1540, -1)->Set(DGNN);
...
func CreateDecoration()
{
  ...
  CreateObject(WLSN, 1120, 470, -1)->Set("Heights","Wood");
  CreateObject(WLSN, 1960, 470, -1)->Set("Heights","Wood");
