...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_MorayTowers.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  DrawMaterialQuad("Wall-Concrete2",1470,860,1480,850,1500,860,1490,870,true);
  ...
  DrawMaterialQuad("Wall-Concrete2",2950,850,2960,860,2940,870,2930,860,true);
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 1650, 760, -1)->Set(1,1);
  CreateObject(SBBA, 1650, 850, -1)->Set(1);
  CreateObject(SBBA, 1770, 1180, -1)->Set(1,1);
  CreateObject(SBBA, 1850, 1080, -1)->Set(1,1);
  CreateObject(SBBA, 2581, 1080, -1)->Set(0,1);
  CreateObject(SBBA, 2660, 1180, -1)->Set(0,1);
  CreateObject(SBBA, 2781, 760, -1)->Set(0,1);
  ...
  CreateObject(GTNG, 1484, 890, -1);
  CreateObject(GTNG, 2946, 890, -1);
  ...
  //Zikaden
  CreateObject(SE4K, 500, 500, -1)->Set("Cicada*.ogg",700,100, 50);
  CreateObject(SE4K, 3930, 500, -1)->Set("Cicada*.ogg",700,100, 50);

  //Rush Hour
  CreateObject(SE4K, 1360, 1410, -1)->Set("Traffic*.ogg",300,100);
  CreateObject(SE4K, 2215, 1530, -1)->Set("Traffic*.ogg",300,100, 75);
  CreateObject(SE4K, 3070, 1410, -1)->Set("Traffic*.ogg",300,100);

  //Sirenen
  CreateObject(SE4K, 1000, 1410, -1)->Set("Siren*.ogg",3500,500, 75);
  CreateObject(SE4K, 3430, 1410, -1)->Set("Siren*.ogg",3500,500, 75);

  //Wind
  CreateObject(SE4K, 1000, 300, -1)->Set("WindSound*.ogg",800,200, 75);
  CreateObject(SE4K, 2215, 450, -1)->Set("WindSound*.ogg",800,200, 75);
  CreateObject(SE4K, 3430, 300, -1)->Set("WindSound*.ogg",800,200, 75);

  //Innenbereich
  CreateObject(SE4K, 1235, 600, -1)->Set("Interior*.ogg",800,300, 50,75);
  CreateObject(SE4K, 1470, 820, -1)->Set("InteriorStress*.ogg",800,300, 50,75);
  CreateObject(SE4K, 1660, 1120, -1)->Set("Interior*.ogg",800,300, 50,75);
  CreateObject(SE4K, 2770, 1120, -1)->Set("Interior*.ogg",800,300, 50,75);
  CreateObject(SE4K, 2960, 820, -1)->Set("InteriorStress*.ogg",800,300, 50,75);
  CreateObject(SE4K, 3195, 600, -1)->Set("Interior*.ogg",800,300, 50,75);
}
...
func CreateEquipment()
{
  ...
  PlaceSpawnpoint(ABOX, 2130, 1215);
  PlaceSpawnpoint(ABOX, 3170, 715);

  //Gewehrgranaten
  PlaceSpawnpoint(GBOX, 1570, 925);
  PlaceSpawnpoint(GBOX, 2300, 1215);
  PlaceSpawnpoint(GBOX, 2860, 925);
...
func CreateDecoration()
{
  ...
  //Scheinwerfer
  CreateObject(FLGH, 1345, 550, -1)->Set(1,1,0,45);
  CreateObject(FLGH, 1565, 720, -1)->Set(1,1,1,-45,90);
  CreateObject(FLGH, 1740, 1030, -1)->Set(1,1,0,45);
  CreateObject(FLGH, 2020, 1152, -1)->Set(1,1,0,45);
  CreateObject(FLGH, 2410, 1152, -1)->Set(1,0,0,-45);
  CreateObject(FLGH, 2690, 1030, -1)->Set(1,0,0,-45);
  CreateObject(FLGH, 2865, 720, -1)->Set(1,0,1,45,-90);
  CreateObject(FLGH, 3085, 550, -1)->Set(1,0,0,-45);
  ...
  //Hinweisschilder
  CreateObject(WLSN, 1538, 755, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 2890, 755, -1)->Set("Extinguisher","Red");
  ...
  CreateObject(BANR, 1355, 550, -1)->SetClrModulation(RGB(50,50,255));
  CreateObject(BANR, 1555, 700, -1)->SetClrModulation(RGB(50,50,255));
  CreateObject(BANR, 2875, 700, -1)->SetClrModulation(RGB(255,0,0));
  CreateObject(BANR, 3075, 550, -1)->SetClrModulation(RGB(255,0,0));
...
public func ChooserFinished()
{
  ...
  if(!FindObject(NOHC))
  {
    SetupVehicleSpawn([LBRD],DIR_Left,CreateObject(VSPW,2215,970,-1),100*21);

    CreateObject(SGNP, 2130, 990, -1)->Set("Helicopter",1);
  }
