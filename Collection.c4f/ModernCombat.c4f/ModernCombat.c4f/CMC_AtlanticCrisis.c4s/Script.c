...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_AtlanticCrisis.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  //Lichter ausschalten
  LightsOff();
  return 1;
}
...
func CreateInterior()
{
  ...
  //Leitern
  CreateObject(LADR, 1275, 594, -1)->Set(11);
  CreateObject(LADR, 1550, 586, -1)->Set(6);
  CreateObject(LADR, 1575, 502, -1)->Set(12);

  CreateObject(LADR, 2200, 600, -1)->Set(9);
  CreateObject(LADR, 2400, 600, -1)->Set(9);

  CreateObject(LADR, 2765, 601, -1)->Set(8);
  ...
  CreateObject(LADR, 3215, 601, -1)->Set(8);

  CreateObject(LADR, 3610, 600, -1)->Set(9);
  CreateObject(LADR, 3810, 600, -1)->Set(9);

  CreateObject(LADR, 4435, 502, -1)->Set(12);
  CreateObject(LADR, 4460, 586, -1)->Set(6);
  CreateObject(LADR, 4737, 594, -1)->Set(11);
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 1705, 540, -1)->Set(1,1);
  CreateObject(SBBA, 2115, 520, -1)->Set(0,1);
  CreateObject(SBBA, 2306, 510, -1)->Set(1);
  CreateObject(SBBA, 3704, 510, -1);
  CreateObject(SBBA, 3895, 520, -1)->Set(1,1);
  CreateObject(SBBA, 4305, 540, -1)->Set(0,1);
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 1680, 400, -1)->Set(ABOX);
  CreateObject(AMCT, 4330, 400, -1)->Set(ABOX);

  //Versorgungskiste (Gewehrgranaten)
  CreateObject(AMCT, 3020, 460, -1)->Set(GBOX);
...
func CreateDecoration()
{
  ...
  //Bojen
  CreateObject(BUOY, 1170, 633, -1);
  CreateObject(BUOY, 2510, 633, -1);
  CreateObject(BUOY, 3500, 633, -1);
  CreateObject(BUOY, 4835, 633, -1);
  ...
  //Hinweisschilder
  CreateObject(WLSN, 1515, 590, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 2970, 440, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 4495, 590, -1)->Set("Extinguisher","Red");
...
{
  //Hintergründe
  CreateObject(BD03,700,800,-1);
  CreateObject(BD03,1700,700,-1);
  CreateObject(BD03,3000,800,-1);
...
public func ChooserFinished()
{
  ...
  if(!FindObject(NOHC))
  {
    ...
    CreateObject(SGNP, 1600, 400, -1)->Set("Helicopter",1);
    CreateObject(SGNP, 4410, 400, -1)->Set("Helicopter",1);
  }
  ...
  if(FindObject(GBAS))
  {
    ...
    //Sprengsatz-Spawn
    SetupBombSpawnpoint([[2990,380],[2990,460],[2990,530]]);

    //Bojen
    CreateObject(BUOY, 1960, 633, -1);
    CreateObject(BUOY, 4050, 633, -1);
  ...
  if(FindObject(GHTF))
  {
    ...
    if(!FindObject(NOAM))
    {
      ...
      CreateObject(AMCT, 2965, 460, -1)->Set(ABOX);
    }
  }
