...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_MankelOverpass.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  DrawMaterialQuad("Wall-Stripes",1500,1430,1500,1435,1490,1435,1480,1430,true);
  ...
  DrawMaterialQuad("Wall-Stripes",2550,1430,2550,1435,2540,1435,2530,1430,true);
  DrawMaterialQuad("Wall-Stripes",2790,1430,2790,1435,2800,1435,2810,1430,true);
  ...
  DrawMaterialQuad("Wall-Stripes",3090,1430,3090,1435,3080,1435,3070,1430,true);
  DrawMaterialQuad("Wall-Stripes",3330,1430,3330,1435,3340,1435,3350,1430,true);
  ...
  DrawMaterialQuad("Wall-Stripes",4380,1430,4380,1435,4390,1435,4400,1430,true);
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 1470, 1030, -1)->Set(1,1);
  CreateObject(SBBA, 1490, 1420, -1)->Set(1,1);
  CreateObject(SBBA, 1751, 1030, -1)->Set(0,1);
  CreateObject(SBBA, 2351, 820, -1)->Set(0,1);
  CreateObject(SBBA, 2385, 172, -1)->Set(0,1);
  CreateObject(SBBA, 2385, 353, -1)->Set(0,1);
  CreateObject(SBBA, 2455, 172, -1)->Set(1,1);
  CreateObject(SBBA, 2455, 353, -1)->Set(1,1);
  CreateObject(SBBA, 2490, 820, -1)->Set(1,1);
  CreateObject(SBBA, 2540, 1420, -1)->Set(1,1);
  CreateObject(SBBA, 2822, 740, -1)->Set(0,1);
  CreateObject(SBBA, 2822, 820, -1);
  CreateObject(SBBA, 3058, 740, -1)->Set(1,1);
  CreateObject(SBBA, 3058, 820, -1)->Set(1);
  CreateObject(SBBA, 3341, 1420, -1)->Set(0,1);
  CreateObject(SBBA, 3391, 820, -1)->Set(0,1);
  CreateObject(SBBA, 3425, 172, -1)->Set(0,1);
  CreateObject(SBBA, 3425, 353, -1)->Set(0,1);
  CreateObject(SBBA, 3495, 172, -1)->Set(1,1);
  CreateObject(SBBA, 3495, 353, -1)->Set(1,1);
  CreateObject(SBBA, 3530, 820, -1)->Set(1,1);
  CreateObject(SBBA, 4130, 1030, -1)->Set(1,1);
  CreateObject(SBBA, 4391, 1420, -1)->Set(0,1);
  CreateObject(SBBA, 4411, 1030, -1)->Set(0,1);
...
func CreateEquipment()
{
  ...
  //Patrouillenboote
  SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1350,1459,-1),50*21);
  SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1435,1459,-1),50*21);
  ...
  SetupVehicleSpawn([PBOT],DIR_Left,CreateObject(VSPW,4445,1459,-1),50*21);
  SetupVehicleSpawn([PBOT],DIR_Left,CreateObject(VSPW,4530,1459,-1),50*21);
}
...
func CreateDecoration()
{
  ...
  //Hinweisschilder
  CreateObject(WLSN, 1010, 775, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 1820, 975, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 4060, 975, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 4870, 775, -1)->Set("Extinguisher","Red");
...
public func ChooserFinished()
{
  ...
  if(!FindObject(NOHC))
  {
    ...
    SetupVehicleSpawn([LBRD],DIR_Right,CreateObject(VSPW,2940,1020,-1),100*21,80);
    ...
    CreateObject(SGNP, 1230, 740, -1)->Set("Helicopter",1);
    CreateObject(SGNP, 1880, 740, -1)->Set("Helicopter",1);
    CreateObject(SGNP, 4000, 740, -1)->Set("Helicopter",1);
    CreateObject(SGNP, 4650, 740, -1)->Set("Helicopter",1);
  }
