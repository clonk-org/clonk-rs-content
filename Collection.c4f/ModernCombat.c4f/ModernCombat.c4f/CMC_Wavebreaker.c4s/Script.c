...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_Wavebreaker.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  CreateObject(LADR, 2946, 1030, -1)->Set(6, LADR_Left|LADR_Right|LADR_Front|LADR_Additional, "W");
  CreateObject(LADR, 3024, 1215, -1)->Set(29, LADR_Left|LADR_Right|LADR_Front|LADR_Additional, "W");
  ...
  CreateObject(LADR, 4176, 1215, -1)->Set(29, LADR_Left|LADR_Right|LADR_Front|LADR_Additional, "W");
  CreateObject(LADR, 4254, 1030, -1)->Set(6, LADR_Left|LADR_Right|LADR_Front|LADR_Additional, "W");
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 2380, 1140, -1)->Set(1);
  CreateObject(SBBA, 3121, 1190, -1)->Set(0,1);
  CreateObject(SBBA, 3160, 790, -1)->Set(1,1);
  CreateObject(SBBA, 3240, 1690, -1)->Set(1,1);
  CreateObject(SBBA, 3491, 920, -1);
  CreateObject(SBBA, 3511, 860, -1);
  CreateObject(SBBA, 3689, 860, -1)->Set(1);
  CreateObject(SBBA, 3710, 920, -1)->Set(1);
  CreateObject(SBBA, 3961, 1690, -1)->Set(0,1);
  CreateObject(SBBA, 4040, 790, -1)->Set(0,1);
  CreateObject(SBBA, 4080, 1190, -1)->Set(1,1);
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 4030, 1760, -1)->Set(GBOX);
  CreateObject(AMCT, 5385, 1142, -1)->Set(GBOX);

  //Raketen
  PlaceSpawnpoint(MBOX, 1620, 1105);
  PlaceSpawnpoint(MBOX, 2975, 1575);
  PlaceSpawnpoint(MBOX, 4225, 1575);
...
func CreateDecoration()
{
  ...
  CreateObject(WLSN, 3155, 1685, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 4045, 1685, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 5700, 1025, -1)->Set("Extinguisher","Red");
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    if(!FindObject(NOHC))
    {
      SetupVehicleSpawn([APCE],DIR_Right,CreateObject(VSPW,1970,1140,-1),70*21);
      ...
      SetupVehicleSpawn([APCE],DIR_Left,CreateObject(VSPW,5225,1140,-1),70*21);

      CreateObject(SGNP, 1680, 1170, -1)->Set("Helicopter",1);
      CreateObject(SGNP, 5930, 1140, -1)->Set("Helicopter",1);
    }
    ...
    //Hinweisschild
    CreateObject(SGNP, 3645, 1260, -1)->Set("Turret",0,1);
  ...
  if(FindObject(GHTF))
  {
    ...
    //Sandsackbarrieren
    CreateObject(SBBA, 3540, 1690, -1)->Set(0,1);
    CreateObject(SBBA, 3660, 1690, -1)->Set(1,1);
    ...
    if(!FindObject(NOHC))
    {
      ...
      CreateObject(SGNP, 2730, 1150, -1)->Set("Helicopter",1);
      CreateObject(SGNP, 4470, 1150, -1)->Set("Helicopter",1);
    }
  }
  ...
  if(FindObject(GASS))
  {
    ...
    CreateObject(SBBA, 5540, 1260, -1)->Set(1);
    ...
    if(!FindObject(NOHC))
    {
      ...
      CreateObject(SGNP, 1680, 1170, -1)->Set("Helicopter",1);
      CreateObject(SGNP, 5520, 1170, -1)->Set("Helicopter",1);
    }
