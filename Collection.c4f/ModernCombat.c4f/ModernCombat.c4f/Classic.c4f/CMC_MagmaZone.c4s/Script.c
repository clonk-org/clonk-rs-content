...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_MagmaZone.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  CreateObject(SGNP, 1590, 550, -1)->Set("Turret",1);
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    if(!FindObject(NOAM))
    {
      ...
      CreateObject(AMCT, 445, 550, -1)->Set(ABOX);
      CreateObject(AMCT, 1515, 460, -1)->Set(ABOX);
      CreateObject(AMCT, 2275, 560, -1)->Set(ABOX);
    }
  }
  ...
  if(FindObject(GCTF))
  {
    ...
    //Sandsackbarrieren
    CreateObject(SBBA, 430, 300, -1)->Set(1,1);
    CreateObject(SBBA, 2271, 240, -1)->Set(0,1);

    //Zusätzliche Munition
    if(!FindObject(NOAM))
    {
      //Versorgungskisten (Kugeln)
      CreateObject(AMCT, 805, 520, -1)->Set(ABOX);
      CreateObject(AMCT, 2025, 450, -1)->Set(ABOX);
    }
  }
  ...
  if(FindObject(GLMS) || FindObject(GTDM))
  {
    ...
    //Sandsackbarrieren
    CreateObject(SBBA, 750, 350, -1)->Set(1,1);
    CreateObject(SBBA, 1961, 290, -1)->Set(0,1);
