...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_EndlessOutpost.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  DrawMaterialQuad("Wall-Concrete1",2850,580,2910,560,2910,580,2850,580,true);
  DrawMaterialQuad("Wall-Concrete1",1980,550,2120,580,1980,580,1980,550,true);
  ...
  CreateObject(LADR, 2190, 538, -1)->Set(5);
  CreateObject(LADR, 2270, 578, -1)->Set(10);
  CreateObject(LADR, 2280, 470, -1)->Set(8);
  ...
  CreateObject(HA4K, 2190, 493, -1);
  CreateObject(HA4K, 2270, 493, -1);
  ...
  CreateObject(SFFG, 675, 540, -1)->Set(3);
  CreateObject(SFFG, 755, 540, -1)->Set(4);
  CreateObject(SFFG, 835, 540, -1)->Set(2);
  ...
  //Gitter
  CreateObject(GTNG, 1973, 550, -1);
  CreateObject(GTNG, 2113, 110, -1);
  ...
  aDoor[03]->Lock();
  aDoor[04] = CreateObject(HNG3,1835,140,-1);
  aDoor[04]->SwitchDestructability();

  aDoor[05] = CreateObject(HNG3,1755,550,-1);
  aDoor[05]->SwitchDestructability();
  ...
  aDoor[08]->Lock();
  aDoor[09] = CreateObject(SEDR, 2320, 580, -1);
  aDoor[09]->Lock();
  aDoor[10] = CreateObject(HNG3,2305,490,-1);
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 535, 450, -1)->Set(ABOX);
  CreateObject(AMCT, 1680, 550, -1)->Set(ABOX);
  CreateObject(AMCT, 2120, 210, -1)->Set(ABOX);

  //Versorgungskiste (Gewehrgranaten)
  CreateObject(AMCT, 1490, 430, -1)->Set(GBOX);

  //Versorgungskiste (Splittergranaten)
  CreateObject(AMCT, 2430, 210, -1)->Set(FRAG);
...
func CreateDecoration()
{
  ...
  CreateObject(TRE1,886,651,-1)->SetCon(40);
  CreateObject(TRE4,893,630,-1);
  CreateObject(TRE4,946,627,-1)->SetCon(36);
  CreateObject(TRE4,904,627,-1)->SetCon(38);
  CreateObject(TRE2,908,622,-1)->SetCon(30);
  CreateObject(TRB4,1055,641,-1);
  CreateObject(TRE4,544,661,-1)->SetCon(30);
  CreateObject(TRE4,576,666,-1)->SetCon(11);
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    aFlag[0] -> AddSpawnPoint(540,530);
    aFlag[0] -> AddSpawnPoint(690,530);
    if(aTeams[1] == true)
    {
    ...
    aFlag[2] -> AddSpawnPoint(2360,390);
    aFlag[2] -> AddSpawnPoint(2250,570);
    aFlag[2] -> AddSpawnPoint(2080,560);
    aFlag[2]->Set("$Flag3$");
    ...
    //Hinweisschilder
    CreateObject(SGNP, 1180, 410, -1)->Set("Turret",1);
    CreateObject(SGNP, 1810, 550, -1)->Set("Turret",1);
  ...
  if(FindObject(GASS))
  {
    ...
    AddAssaultTarget(LBPC, 2080, 493, 27*30, 2, "$Target4$", 3, [[[2380, 400], [2250, 580], [2170, 580]], [[1450, 200], [1400, 180], [1510, 260]]]);
    ...
    CreateObject(AMCT, 625, 540, -1)->Set(ATWN);
    CreateObject(AMCT, 1340, 160, -1)->Set(ATWN);
    ...
    {
      //Versorgungskisten (Kugeln)
      CreateObject(AMCT, 2725, 580, -1)->Set(ABOX);

      //Raketen
      PlaceSpawnpoint(MBOX, 2980, 345);

      //Gewehrgranaten
      PlaceSpawnpoint(GBOX, 2690, 575);
    }
  }
  else
  {
...
public func RelaunchPosition(& iX, & iY, int iTeam)
{
  ...
  {
    if(iTeam == 1)
      return [[440,340], [520, 340], [520, 440], [540,530], [690,530]];
    if(iTeam == 2)
      return [[2020, 60], [2160, 200], [2190, 100], [2230,310]];
