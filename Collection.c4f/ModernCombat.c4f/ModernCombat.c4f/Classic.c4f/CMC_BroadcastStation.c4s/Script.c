...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_BroadcastStation.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 635, 710, -1)->Set(1,1);
  CreateObject(SBBA, 1125, 590, -1)->Set(0,1);
  ...
  //Tore
  CreateObject(HNG3, 100, 710, -1)->SwitchDestructability();
  CreateObject(HNG3, 170, 710, -1)->SwitchDestructability();
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 370, 683, -1)->Set(ABOX);
  CreateObject(AMCT, 1255, 190, -1)->Set(ABOX);
...
func CreateDecoration()
{
  ...
  //Hinweisschild
  CreateObject(WLSN, 480, 700, -1)->Set("Explosives","Green");
  ...
  CreateObject(FLGH, 790, 340, -1)->Set(1,1,0,40);
