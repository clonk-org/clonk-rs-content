...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_GroundZero.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  CreateObject(LADR, 365, 283, -1)->Set(7);
  ...
  CreateObject(LADR, 3035, 283, -1)->Set(7);
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 725, 290, -1)->Set(1,1);
  CreateObject(SBBA, 1645, 420, -1)->Set(0,1);
  CreateObject(SBBA, 1755, 420, -1)->Set(1,1);
  CreateObject(SBBA, 2675, 290, -1)->Set(0,1);
  ...
  autod->Open();
  CreateObject(CONS, 1570, 605, -1)->Set(autod);
  var autod = CreateObject(HNG3, 1700, 520, -1);
  autod->Open();
  CreateObject(CONS, 1830, 605, -1)->Set(autod);

  //Soundkulisse

  //Rush Hour
  CreateObject(SE4K, 1120, 390, -1)->Set("Traffic*.ogg",300,100, 25,75);
  CreateObject(SE4K, 2270, 390, -1)->Set("Traffic*.ogg",300,100, 25,75);

  //Sirenen
  CreateObject(SE4K, 750, 350, -1)->Set("Siren*.ogg",4000,200, 25,75);
  CreateObject(SE4K, 2650, 350, -1)->Set("Siren*.ogg",4000,200, 25,75);

  //Wind
  CreateObject(SE4K, 1100, 160, -1)->Set("WindSound*.ogg",800,200, 75);
  CreateObject(SE4K, 2290, 160, -1)->Set("WindSound*.ogg",800,200, 75);

  //Innenbereich
  CreateObject(SE4K, 320, 340, -1)->Set("InteriorMetal*.ogg",1000,300, 25,50);
  CreateObject(SE4K, 490, 340, -1)->Set("Interior*.ogg",700,100);
  CreateObject(SE4K, 915, 340, -1)->Set("InteriorStress*.ogg",700,100);
  CreateObject(SE4K, 1325, 340, -1)->Set("Interior*.ogg",700,100);
  CreateObject(SE4K, 2075, 340, -1)->Set("Interior*.ogg",700,100);
  CreateObject(SE4K, 2485, 340, -1)->Set("InteriorStress*.ogg",700,100);
  CreateObject(SE4K, 2910, 340, -1)->Set("Interior*.ogg",700,100);
  CreateObject(SE4K, 3080, 340, -1)->Set("InteriorMetal*.ogg",1000,300, 25,50);
}
...
func CreateDecoration()
{
  ...
  //Leitkegel
  CreateObject(TCCN, 1215, 450, -1);
  CreateObject(TCCN, 1275, 460, -1);
  CreateObject(TCCN, 1465, 460, -1);
  CreateObject(TCCN, 1515, 440, -1);
  CreateObject(TCCN, 1885, 440, -1);
  CreateObject(TCCN, 1935, 460, -1);
  CreateObject(TCCN, 2225, 460, -1);
  CreateObject(TCCN, 2285, 450, -1);
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    //Hinweisschilder
    CreateObject(SGNP, 780, 450, -1)->Set("Turret",1);
    CreateObject(SGNP, 2620, 450, -1)->Set("Turret",1);
  }
  ...
  if(FindObject(GHTF))
  {
    ...
    //Sandsackbarrieren
    CreateObject(SBBA, 1521, 440, -1)->Set(0,1);
    CreateObject(SBBA, 1581, 430, -1)->Set(0,1);
    CreateObject(SBBA, 1820, 430, -1)->Set(1,1);
    CreateObject(SBBA, 1880, 440, -1)->Set(1,1);
