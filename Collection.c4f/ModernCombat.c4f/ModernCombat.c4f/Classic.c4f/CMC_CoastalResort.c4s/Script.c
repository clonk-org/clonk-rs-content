...
static aFlag,aSelfDefense,aLights,iLightsCounter,aDoorWay;
...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_CoastalResort.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  //Lichter ausschalten
  LightsOff();
  return 1;
}
...
func CreateInterior()
{
  ...
  CreateObject(PAN2, 4155, 796, -1);
  CreateObject(PAN2, 4155, 802, -1);
  CreateObject(PAN2, 4335, 796, -1);
  CreateObject(PAN2, 4335, 802, -1);
  ...
  //Verbundene Räume
  aDoorWay[00] = CreateObject(GAT1, 3915, 525, -1);
  aDoorWay[01] = CreateObject(ROOM, 3100, 940, -1);
  aDoorWay[00]->Connect(aDoorWay[01]);
  aDoorWay[02] = CreateObject(ROM2, 3915, 900, -1);
  aDoorWay[03] = CreateObject(ROM2, 3960, 790, -1);
  ...
  aDoorWay[04] = CreateObject(GAT1, 4575, 525, -1);
  aDoorWay[05] = CreateObject(ROOM, 5390, 940, -1);
  aDoorWay[04]->Connect(aDoorWay[05]);
  ...
  //Erdrutsche
  CreateObject(SE4K, 1065, 980, -1)->Set("FallingDirt*.ogg",800,200, 75);
  CreateObject(SE4K, 7580, 980, -1)->Set("FallingDirt*.ogg",800,200, 75);

  //Wellen
  CreateObject(SE4K, 500, 1010, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 1300, 1010, -1)->Set("Wave*.ogg",100,50, 75);
  CreateObject(SE4K, 2670, 1010, -1)->Set("Wave*.ogg",100,50, 75);
  CreateObject(SE4K, 3490, 1010, -1)->Set("Wave*.ogg",100,50, 50,75);
  CreateObject(SE4K, 4250, 1010, -1)->Set("Wave*.ogg",100,50, 25,50);
  CreateObject(SE4K, 4970, 1010, -1)->Set("Wave*.ogg",100,50, 50,75);
  CreateObject(SE4K, 5820, 1010, -1)->Set("Wave*.ogg",100,50, 75);
  CreateObject(SE4K, 7360, 1010, -1)->Set("Wave*.ogg",100,50, 75);
  CreateObject(SE4K, 8150, 1010, -1)->Set("Wave*.ogg",100,50);

  //Jungel
  CreateObject(SE4K, 1900, 900, -1)->Set("Jungle*.ogg",300,200);
  CreateObject(SE4K, 6650, 900, -1)->Set("Jungle*.ogg",300,200);

  //Wind
  CreateObject(SE4K, 1100, 300, -1)->Set("WindSound*.ogg",3000,100, 75);
  CreateObject(SE4K, 2100, 300, -1)->Set("WindSound*.ogg",3000,100, 75);
  CreateObject(SE4K, 3100, 300, -1)->Set("WindSound*.ogg",3000,100, 50,75);
  CreateObject(SE4K, 4250, 300, -1)->Set("WindSound*.ogg",3000,100, 50,75);
  CreateObject(SE4K, 5550, 300, -1)->Set("WindSound*.ogg",3000,100, 50,75);
  CreateObject(SE4K, 6550, 300, -1)->Set("WindSound*.ogg",3000,100, 75);
  CreateObject(SE4K, 7550, 300, -1)->Set("WindSound*.ogg",3000,100, 75);
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 2280, 970, -1)->Set(ABOX);
  CreateObject(AMCT, 6370, 970, -1)->Set(ABOX);
  CreateObject(AMCT, 4180, 900, -1)->Set(ABOX);

  //Versorgungskisten (Gewehrgranaten)
  CreateObject(AMCT, 2320, 970, -1)->Set(GBOX);
  CreateObject(AMCT, 6330, 970, -1)->Set(GBOX);
  CreateObject(AMCT, 4310, 900, -1)->Set(GBOX);
  ...
  CreateObject(AMCT, 3725, 950, -1)->Set(DGNN);
  CreateObject(AMCT, 4765, 950, -1)->Set(DGNN);
...
{
  //Hintergründe
  CreateObject(BD03,1200,670,-1);
  CreateObject(BD03,3300,650,-1);
  CreateObject(BD03,5400,690,-1);
  CreateObject(BD05,1550,1200,-1);
  CreateObject(BD08,400,1300,-1);
  CreateObject(BD08,1300,1300,-1);
  CreateObject(BD05,2750,1130,-1)->Local()=45;
  CreateObject(BD08,3700,1300,-1)->Local()=45;
  CreateObject(BD08,4600,1300,-1)->Local()=45;
