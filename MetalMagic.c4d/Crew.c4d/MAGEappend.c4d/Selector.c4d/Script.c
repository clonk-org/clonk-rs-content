...
protected func ControlRight()         { ClearLastPlrCom(GetController()); return(Forward()); }  // vor
protected func ControlLeft()          { ClearLastPlrCom(GetController()); return(Backward()); } // zurück
...
public func DoEnter()
  ...
  pTargetObject = 0; Close(0,pTarget);
...
public func Close(bool fDontRemove,pTarget)
  {
...
{
  // Pfeil verliert sein Command-Target(Zauberer weg)
  if (!pCallbackObject) { RemoveObject(); return; }
