...
{
  [$TxtLeftgate$]
  if(GetY(caller)-GetY()<-33)return;
  if(GetAction() == "Idle") return SetAction("LeftClosed") ;
  if(GetAction() == "LeftClosed") return AllOpen() ;
  if(GetAction() == "RightClosed") return SetAction("BothClosed") ;
  if(GetAction() == "BothClosed") return SetAction("RightClosed") ;
}
...
protected func ControlRight(caller)
{
  [$TxtRightgate$]
  if(GetY(caller)-GetY()<-33)return;
  if(GetAction() == "Idle") return SetAction("RightClosed");
  if(GetAction() == "RightClosed") return AllOpen();
  if(GetAction() == "LeftClosed") return SetAction("BothClosed");
  if(GetAction() == "BothClosed") return SetAction("LeftClosed");
}
...
{
  if(GetAction() == "RightClosed") return 0;
  if(GetAction() == "BothClosed") return 0;
  return 1;
}

private func LeftGateOpen()
{
  if(GetAction() == "LeftClosed") return 0;
  if(GetAction() == "BothClosed") return 0;
  return 1;
}
...
{
  var gatephase = 0;
  if(GetAction() == "BothClosed") gatephase = 1;
  else if(GetAction() == "LeftClosed") gatephase = 2;
  else if(GetAction() == "RightClosed") gatephase = 3;
