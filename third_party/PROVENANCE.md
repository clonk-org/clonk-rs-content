...
| `Melees.c4f/Queron3.c4s` | maintained derivative | CCAN entry 5737; artifact name and SHA-256: `unknown` | `Author.txt` and the script's author/version line | historical source record describes a public reuse note conditioned on preserving authorship; exact permission scope: `unknown` | commit [`d34d3855`](https://github.com/clonk-org/clonk-rs-content/commit/d34d385591134ce6c262b8c9ed53faaa6229cc6b); tree `b6c1018e143005c50a6456be45c35354f7fbd233`; baseline already localized | [#68](https://github.com/clonk-org/clonk-rs-content/issues/68) |
