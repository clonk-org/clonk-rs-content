...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_BlackThunder.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 361, 560, -1)->Set(0,1);
  CreateObject(SBBA, 401, 440, -1)->Set(0,1);
  CreateObject(SBBA, 440, 440, -1)->Set(1,1);
  CreateObject(SBBA, 711, 760, -1)->Set(0,1);
  CreateObject(SBBA, 780, 760, -1)->Set(1,1);
  CreateObject(SBBA, 1055, 1170, -1)->Set(1,1);
  CreateObject(SBBA, 1101, 670, -1)->Set(0,1);
  CreateObject(SBBA, 1101, 760, -1)->Set(0,1);
  CreateObject(SBBA, 1350, 850, -1)->Set(1,1);
  CreateObject(SBBA, 1391, 590, -1)->Set(0,1);
  CreateObject(SBBA, 1430, 590, -1)->Set(1,1);
  CreateObject(SBBA, 1470, 670, -1)->Set(1,1);

  CreateObject(SBBA, 1923, 850, -1)->Set(0,1);
  CreateObject(SBBA, 1961, 750, -1)->Set(0,1);
  CreateObject(SBBA, 2280, 750, -1)->Set(1,1);
  CreateObject(SBBA, 2318, 850, -1)->Set(1,1);

  CreateObject(SBBA, 2771, 670, -1)->Set(0,1);
  CreateObject(SBBA, 2811, 590, -1)->Set(0,1);
  CreateObject(SBBA, 2850, 590, -1)->Set(1,1);
  CreateObject(SBBA, 2891, 850, -1)->Set(0,1);
  CreateObject(SBBA, 3140, 670, -1)->Set(1,1);
  CreateObject(SBBA, 3140, 760, -1)->Set(1,1);
  CreateObject(SBBA, 3140, 1240, -1)->Set(0,1);
  CreateObject(SBBA, 3461, 760, -1)->Set(0,1);
  CreateObject(SBBA, 3530, 760, -1)->Set(1,1);
  CreateObject(SBBA, 3801, 440, -1)->Set(0,1);
  CreateObject(SBBA, 3840, 440, -1)->Set(1,1);
  CreateObject(SBBA, 3880, 560, -1)->Set(1,1);
  ...
  //Jungel
  CreateObject(SE4K, 200, 1100, -1)->Set("Jungle*.ogg",800,200, 75);
  CreateObject(SE4K, 800, 1100, -1)->Set("Jungle*.ogg",300,200, 75);
  CreateObject(SE4K, 1400, 1100, -1)->Set("Jungle*.ogg",800,200, 75);
  CreateObject(SE4K, 2000, 1100, -1)->Set("Jungle*.ogg",300,200, 75);
  CreateObject(SE4K, 2600, 1100, -1)->Set("Jungle*.ogg",800,200, 75);
  CreateObject(SE4K, 3500, 1100, -1)->Set("Jungle*.ogg",300,200, 75);
  CreateObject(SE4K, 4100, 1100, -1)->Set("Jungle*.ogg",800,200, 75);

  //Wind
  CreateObject(SE4K, 1000, 250, -1)->Set("WindSound*.ogg",800,300, 75);
  CreateObject(SE4K, 2120, 250, -1)->Set("WindSound*.ogg",800,300, 50,75);
  CreateObject(SE4K, 3240, 250, -1)->Set("WindSound*.ogg",800,300, 75);

  //Innenbereich
  CreateObject(SE4K, 600, 600, -1)->Set("Interior*.ogg",1000,300, 50,75);
  CreateObject(SE4K, 600, 600, -1)->Set("InteriorStress*.ogg",1000,300, 75);
  CreateObject(SE4K, 1280, 750, -1)->Set("Interior*.ogg",700,100, 75);
  CreateObject(SE4K, 2120, 750, -1)->Set("Interior*.ogg",700,100, 25,50);
  CreateObject(SE4K, 2960, 750, -1)->Set("Interior*.ogg",700,100, 75);
  CreateObject(SE4K, 3640, 600, -1)->Set("Interior*.ogg",1000,300, 50,75);
  CreateObject(SE4K, 3640, 600, -1)->Set("InteriorStress*.ogg",1000,300, 75);
}
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 415, 500, -1)->Set(ABOX);
  CreateObject(AMCT, 3830, 500, -1)->Set(ABOX);

  //Versorgungskisten (Gewehrgranaten)
  CreateObject(AMCT, 1180, 670, -1)->Set(GBOX);
  CreateObject(AMCT, 3060, 670, -1)->Set(GBOX);

  //Versorgungskisten (APW)
  CreateObject(AMCT, 510, 730, -1)->Set(ATWN);
  CreateObject(AMCT, 3730, 730, -1)->Set(ATWN);
...
func CreateDecoration()
{
  ...
  //Hinweisschilder
  CreateObject(WLSN, 480, 550, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 1220, 665, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 3020, 665, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 3760, 550, -1)->Set("Extinguisher","Red");
  ...
  CreateObject(BSH2,1965,1180,-1);
  CreateObject(TRE3,2020,1216,-1);
  CreateObject(BSH2,2030,1220,-1);
  CreateObject(BSH2,2060,1200,-1)->SetCon(56);
  CreateObject(TRE2,2084,1175,-1);
  CreateObject(TRE1,2124,1177,-1);
  CreateObject(TRE1,2153,1180,-1);
  CreateObject(BSH2,2210,1210,-1);
...
public func ChooserFinished()
{
  ...
  if(!FindObject(NOHC))
  {
    ...
    CreateObject(SGNP, 1290, 670, -1)->Set("Helicopter",1);
    CreateObject(SGNP, 2940, 670, -1)->Set("Helicopter",1);
  ...
  if(FindObject(GBAS))
  {
    ...
    //Versorgungskisten (APW)
    CreateObject(AMCT, 1250, 850, -1)->Set(ATWN);
    CreateObject(AMCT, 2990, 850, -1)->Set(ATWN);
  ...
  if(FindObject(GCTF))
  {
    ...
    CreateObject(AMCT, 2120, 1170, -1)->Set(ATWN);
