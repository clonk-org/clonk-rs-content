...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_Firewood.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 490, 300, -1)->Set(1,1);
  CreateObject(SBBA, 440, 300, -1)->Set(0,1);
  CreateObject(SBBA, 827, 390, -1)->Set(1);
  CreateObject(SBBA, 1665, 100, -1)->Set(1,1);
  CreateObject(SBBA, 1615, 100, -1)->Set(0,1);
  CreateObject(SBBA, 2453, 390, -1);
  CreateObject(SBBA, 2830, 300, -1)->Set(1,1);
  CreateObject(SBBA, 2785, 300, -1)->Set(0,1);
  ...
  CreateObject(SE4K, 1225, 470, -1)->Set("BirdSong*",200,50);
  CreateObject(SE4K, 1395, 310, -1)->Set("BirdSong*",200,50);
  CreateObject(SE4K, 1940, 310, -1)->Set("BirdSong*",200,50);
  CreateObject(SE4K, 2050, 470, -1)->Set("BirdSong*",200,50);
  CreateObject(SE4K, 2960, 480, -1)->Set("BirdSong*",200,50);
  ...
  //Wellen
  CreateObject(SE4K, 880, 600, -1)->Set("Wave*.ogg",100,50, 75);
  CreateObject(SE4K, 2400, 600, -1)->Set("Wave*.ogg",100,50, 75);

  //Erdrutsche
  CreateObject(SE4K, 985, 520, -1)->Set("FallingDirt*.ogg",2000,500, 75);
  CreateObject(SE4K, 2300, 520, -1)->Set("FallingDirt*.ogg",2000,500, 75);

  //Lautsprecher
  CreateObject(SE4K, 465, 220, -1)->Set("Announce*.ogg",3000,500, 75);
  CreateObject(SE4K, 1640, 20, -1)->Set("Announce*.ogg",3000,500, 75);
  CreateObject(SE4K, 2810, 220, -1)->Set("Announce*.ogg",3000,500, 75);

  //Wind
  CreateObject(SE4K, 1065, 290, -1)->Set("WindSound*.ogg",2500,500, 50);
  CreateObject(SE4K, 2215, 290, -1)->Set("WindSound*.ogg",2500,500, 50);
}
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 555, 300, -1)->Set(ABOX);
  CreateObject(AMCT, 1615, 210, -1)->Set(ABOX);
  CreateObject(AMCT, 2725, 300, -1)->Set(ABOX);

  //Versorgungskisten (Handgranaten)
  CreateObject(AMCT, 1340, 520, -1)->Set(FRAG);
  CreateObject(AMCT, 1945, 520, -1)->Set(FRAG);
...
func CreateDecoration()
{
  ...
  //Hinweisschilder
  CreateObject(WLSN, 460, 385, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 2820, 385, -1)->Set("Extinguisher","Red");
