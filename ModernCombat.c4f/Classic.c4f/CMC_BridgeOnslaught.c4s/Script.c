...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_BridgeOnslaught.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  CreateObject(LADR, 685, 416, -1)->Set(18);
  CreateObject(LADR, 785, 775, -1)->Set(16);
  CreateObject(LADR, 955, 623, -1)->Set(22);
  CreateObject(LADR, 1010, 777, -1)->Set(15);
  ...
  CreateObject(LADR, 2120, 777, -1)->Set(15);
  CreateObject(LADR, 2175, 623, -1)->Set(22);
  CreateObject(LADR, 2345, 775, -1)->Set(16);
  CreateObject(LADR, 2445, 416, -1)->Set(18);
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 990, 800, -1)->Set(1,1);
  CreateObject(SBBA, 1050, 390, -1)->Set(1,1);
  CreateObject(SBBA, 1160, 640, -1)->Set(0,1);
  CreateObject(SBBA, 1360, 800, -1)->Set(0,1);
  CreateObject(SBBA, 1460, 640, -1);
  CreateObject(SBBA, 1670, 640, -1)->Set(1);
  CreateObject(SBBA, 1770, 800, -1)->Set(1,1);
  CreateObject(SBBA, 1970, 640, -1)->Set(1,1);
  CreateObject(SBBA, 2076, 390, -1)->Set(0,1);
  CreateObject(SBBA, 2140, 800, -1)->Set(0,1);
  ...
  //Tore
  CreateObject(HNG3, 375, 440, -1)->SwitchDestructability();
  CreateObject(HNG3, 565, 630, -1)->SwitchDestructability();
  CreateObject(HNG3, 2565, 630, -1)->SwitchDestructability();
  CreateObject(HNG3, 2755, 440, -1)->SwitchDestructability();
  ...
  //Rush Hour
  CreateObject(SE4K, 700, 850, -1)->Set("Traffic*.ogg",300,100, 25,50);
  CreateObject(SE4K, 3430, 850, -1)->Set("Traffic*.ogg",300,100, 25,50);

  //Wind
  CreateObject(SE4K, 700, 150, -1)->Set("WindSound*.ogg",800,300, 75);
  CreateObject(SE4K, 1565, 150, -1)->Set("WindSound*.ogg",800,300, 50,75);
  CreateObject(SE4K, 3430, 150, -1)->Set("WindSound*.ogg",800,300, 75);

  //Innenbereich
  CreateObject(SE4K, 700, 500, -1)->Set("Interior*.ogg",700,100, 50,75);
  CreateObject(SE4K, 700, 500, -1)->Set("InteriorStress*.ogg",700,100, 75);
  CreateObject(SE4K, 1200, 500, -1)->Set("Interior*.ogg",700,100, 50,75);
  CreateObject(SE4K, 1565, 500, -1)->Set("InteriorMetal*.ogg",1000,300, 25,50);
  CreateObject(SE4K, 1930, 500, -1)->Set("Interior*.ogg",1000,300, 50,75);
  CreateObject(SE4K, 2430, 500, -1)->Set("Interior*.ogg",1000,300, 50,75);
  CreateObject(SE4K, 2430, 500, -1)->Set("InteriorStress*.ogg",1000,300, 75);
}
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 730, 730, -1)->Set(ABOX);
  CreateObject(AMCT, 2400, 730, -1)->Set(ABOX);

  //Versorgungskiste (Gewehrgranaten)
  CreateObject(AMCT, 1665, 310, -1)->Set(GBOX);
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    //Hinweisschilder
    CreateObject(SGNP, 1190, 640, -1)->Set("Turret",1);
    CreateObject(SGNP, 1940, 640, -1)->Set("Turret",1);
  }
  ...
  if(FindObject(GBAS))
  {
    ...
    CreateObject(SGNP, 1190, 640, -1)->Set("Turret",1);
    CreateObject(SGNP, 1940, 640, -1)->Set("Turret",1);
    var sign = CreateObject(SNPT, 600, 430, -1);
  ...
  if(FindObject(GHTF))
  {
    ...
    if(!FindObject(NOAM))
    {
      ...
      CreateObject(AMCT, 1530, 640, -1)->Set(ABOX);
    }
  }
