...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_ResearchFacility.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 600, 230, -1)->Set(1);
  CreateObject(SBBA, 620, 1010, -1)->Set(1);
  CreateObject(SBBA, 700, 230, -1)->Set(1);
  CreateObject(SBBA, 945, 1010, -1)->Set(0,1);
  CreateObject(SBBA, 1000, 1010, -1)->Set(1,1);
  CreateObject(SBBA, 1725, 1110, -1)->Set(0,1);
  CreateObject(SBBA, 1731, 1890, -1);
  CreateObject(SBBA, 1805, 1110, -1)->Set(1,1);
  CreateObject(SBBA, 1830, 1740, -1);
  CreateObject(SBBA, 1860, 1890, -1)->Set(1);
  CreateObject(SBBA, 2285, 1100, -1)->Set(1);
  CreateObject(SBBA, 2300, 910, -1)->Set(1);
  CreateObject(SBBA, 2315, 1560, -1);
  CreateObject(SBBA, 2680, 140, -1)->Set(1);
  CreateObject(SBBA, 2750, 270, -1)->Set(1);
  CreateObject(SBBA, 2575, 1100, -1);
  CreateObject(SBBA, 2585, 910, -1);

  //Hinweisschilder
  CreateObject(WLSN, 785, 225, -1)->Set("Heights");
  CreateObject(WLSN, 785, 735, -1)->Set("Heights");
  ...
  sign = CreateObject(SNPT, 2700, 140, -1);
  sign->SetAction("Sign6");
  sign->Light();
...
func CreateDecoration()
{
  ...
  CreateObject(WLSN, 1140, 405, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 2110, 905, -1)->Set("Extinguisher","Red");
...
public func ChooserFinished()
{
  ...
  SetPlayList("CMC_Back in the Earth.ogg;CMC_Breaching.ogg;CMC_Deep Universe.ogg;CMC_Drone in Flight.ogg;CMC_Enemy Approaching.ogg;CMC_Eurocorps.ogg;CMC_Firehawk.ogg;CMC_Getaway.ogg;CMC_Infiltration.ogg;CMC_Locked and Loaded.ogg;CMC_Matrix.ogg;CMC_No Good.ogg;CMC_Obsession.ogg;CMC_Offensive.ogg;CMC_Red Mountain.ogg;CMC_Rock Go On.ogg;CMC_Titanium City.ogg;CMC_Warpfield.ogg;CMC_Your Eyes.ogg");
  ...
  if(FindObject(GASS))
  {
    ...
    //Sandsackbarriere
    CreateObject(SBBA, 2111, 1820, -1)->Set(0,1);
    ...
    //Hinweisschilder
    CreateObject(SGNP, 1555, 1010, -1)->Set("Turret",1);
    CreateObject(SGNP, 2650, 1100, -1)->Set("Turret",1);
  ...
  if(FindObject(GHTF))
  {
    ...
    //Sandsackbarrieren
    CreateObject(SBBA, 1676, 460, -1)->Set(0,1);
    CreateObject(SBBA, 1850, 460, -1)->Set(1,1);
    ...
    //Hinweisschilder
    CreateObject(SGNP, 730, 230, -1)->Set("Danger",1);
    CreateObject(SGNP, 730, 740, -1)->Set("Danger",1);
    CreateObject(SGNP, 730, 1010, -1)->Set("Danger",1);
    CreateObject(SGNP, 765, 90, -1);
    CreateObject(SGNP, 1555, 1010, -1)->Set("Turret",1);
    CreateObject(SGNP, 2840, 1100, -1)->Set("Danger",1);
    CreateObject(SGNP, 2900, 550, -1)->Set("Danger",1);
    CreateObject(SGNP, 2900, 740, -1)->Set("Danger",1);
