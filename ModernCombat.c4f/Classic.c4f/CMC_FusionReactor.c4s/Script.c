...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\Classic.c4f\\CMC_FusionReactor.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 380, 640, -1)->Set(ABOX);
  CreateObject(AMCT, 1450, 640, -1)->Set(ABOX);

  //Versorgungskisten (Gewehrgranaten)
  CreateObject(AMCT, 380, 520, -1)->Set(GBOX);
  CreateObject(AMCT, 1450, 520, -1)->Set(GBOX);

  //Versorgungskiste (Raketen)
  CreateObject(AMCT, 835, 535, -1)->Set(MBOX);

  //Versorgungskiste (Dragnin)
  CreateObject(AMCT, 970, 661, -1)->Set(DGNN);
}
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    //Alarmleuchten
    AddGOCCWarnEffect(CreateObject(ALGH, 655, 210, -1),aFlag[0],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 555, 280, -1),aFlag[0],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 575, 780, -1),aFlag[1],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 700, 890, -1),aFlag[1],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 790, 610, -1),aFlag[2],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 1040, 610, -1),aFlag[2],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 1175, 210, -1),aFlag[3],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 1275, 280, -1),aFlag[3],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 1255, 780, -1),aFlag[4],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 1130, 890, -1),aFlag[4],-180);
  }
