...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_IslandStrike.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Sandsackbarrieren
  CreateObject(SBBA, 1380, 540, -1)->Set(1,1);
  CreateObject(SBBA, 1690, 540, -1)->Set(1,1);
  CreateObject(SBBA, 2660, 440, -1)->Set(0,1);
  CreateObject(SBBA, 3800, 510, -1)->Set(1,1);
  CreateObject(SBBA, 4204, 509, -1)->Set(0,1);
  CreateObject(SBBA, 5075, 500, -1)->Set(0,1);
  CreateObject(SBBA, 5165, 500, -1)->Set(1,1);
  CreateObject(SBBA, 5265, 500, -1)->Set(0,1);
  CreateObject(SBBA, 5355, 500, -1)->Set(1,1);
  CreateObject(SBBA, 5780, 450, -1)->Set(1,1);
  CreateObject(SBBA, 6340, 720, -1)->Set(1,1);
  CreateObject(SBBA, 6490, 440, -1)->Set(1,1);
  ...
  //Möven
  CreateObject(SE4K, 865, 580, -1)->Set("Seagulls*.ogg",1000,500, 10,50);
  CreateObject(SE4K, 2290, 600, -1)->Set("Seagulls*.ogg",1000,500, 10,50);
  CreateObject(SE4K, 4000, 560, -1)->Set("Seagulls*.ogg",1000,500, 10,25);
  CreateObject(SE4K, 5215, 520, -1)->Set("Seagulls*.ogg",1000,500, 10,25);
  CreateObject(SE4K, 6910, 500, -1)->Set("Seagulls*.ogg",1000,500, 10,50);
  CreateObject(SE4K, 7900, 500, -1)->Set("Seagulls*.ogg",1000,500, 10,50);

  //Wellen
  CreateObject(SE4K, 240, 610, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 640, 610, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 1620, 610, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 2090, 610, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 4000, 630, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 4910, 650, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 5370, 650, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 7050, 610, -1)->Set("Wave*.ogg",100,50);
  CreateObject(SE4K, 7660, 610, -1)->Set("Wave*.ogg",100,50);

  //Jungel
  CreateObject(SE4K, 3160, 390, -1)->Set("Jungle*.ogg",300,200, 75);
  CreateObject(SE4K, 3375, 460, -1)->Set("Jungle*.ogg",300,200, 75);
  CreateObject(SE4K, 5850, 440, -1)->Set("Jungle*.ogg",300,200, 75);

  //Lautsprecher
  CreateObject(SE4K, 1140, 430, -1)->Set("Announce*.ogg",3000,500, 75);
  CreateObject(SE4K, 4000, 530, -1)->Set("Announce*.ogg",3000,500, 75);
  CreateObject(SE4K, 7215, 380, -1)->Set("Announce*.ogg",3000,500, 75);

  //Innenbereich
  CreateObject(SE4K, 1415, 550, -1)->Set("Interior*.ogg",800,300, 10,25);
  CreateObject(SE4K, 5215, 550, -1)->Set("Interior*.ogg",800,300, 10,25);
  CreateObject(SE4K, 7450, 550, -1)->Set("InteriorStress*.ogg",800,300, 10,25);
}
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 1060, 640, -1)->Set(ABOX);
  CreateObject(AMCT, 7300, 530, -1)->Set(ABOX);
...
func CreateDecoration()
{
  ...
  //Hinweisschilder
  CreateObject(WLSN, 1065, 560, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 2960, 605, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 5830, 605, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 6200, 605, -1)->Set("Extinguisher","Red");
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    if(!FindObject(NOHC))
    {
      ...
      CreateObject(SGNP, 4810, 420, -1)->Set("Helicopter",1);
    }
    ...
    sign->SetMode(1);
    CreateObject(SGNP, 2530, 570, -1)->Set("Turret",1);
    CreateObject(SGNP, 6620, 570, -1)->Set("Turret",1);
    ...
    //Patrouillenboote
    SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1245,609,-1),50*21);
    ...
    //Alarmleuchten
    AddGOCCWarnEffect(CreateObject(ALGH, 935, 399, -1),aFlag[0],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 1115, 399, -1),aFlag[0],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 1305, 569, -1),aFlag[0],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 2525, 469, -1),aFlag[1],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 2595, 469, -1),aFlag[1],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 2780, 539, -1),aFlag[1],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 3570, 469, -1),aFlag[2],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 3710, 609, -1),aFlag[2],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 4245, 599, -1),aFlag[3],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 4415, 609, -1),aFlag[3],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 5705, 479, -1),aFlag[4],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 5570, 619, -1),aFlag[4],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 6555, 469, -1),aFlag[5],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 6625, 469, -1),aFlag[5],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 6370, 539, -1),aFlag[5],-180);

    AddGOCCWarnEffect(CreateObject(ALGH, 7150, 460, -1),aFlag[6]);
    AddGOCCWarnEffect(CreateObject(ALGH, 7410, 460, -1),aFlag[6]);
  }
  ...
  if(FindObject(GASS))
  {
    ...
    CreateObject(AMCT, 560, 540, -1)->Set(DGNN);

    //Versorgungskiste (APW)
    CreateObject(AMCT, 645, 490, -1)->Set(ATWN);
    ...
    //Patrouillenboote
    SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1245,609,-1),50*21);
    SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1330,609,-1),50*21);
    SetupVehicleSpawn([PBOT],DIR_Left,CreateObject(VSPW,2195,609,-1),50*21);
    SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,4640,649,-1),50*21);
    ...
    {
      //Versorgungskisten (Kugeln)
      CreateObject(AMCT, 2700, 610, -1)->Set(ABOX);
      CreateObject(AMCT, 3715, 570, -1)->Set(ABOX);
      CreateObject(AMCT, 4320, 570, -1)->Set(ABOX);
      CreateObject(AMCT, 6240, 720, -1)->Set(ABOX);
