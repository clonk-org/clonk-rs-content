...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_Base1337.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateInterior()
{
  ...
  //Hinweisschilder
  CreateObject(WLSN, 1290, 935, -1)->Set("Heights","Wood");
  CreateObject(WLSN, 3405, 900, -1)->Set("Explosives","Red");
  ...
  CreateObject(SBBA, 2259, 1120, -1)->Set(1,1);
  CreateObject(SBBA, 2820, 1200, -1)->Set(0,1);
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 1020, 900, -1)->Set(ABOX);
  CreateObject(AMCT, 2170, 940, -1)->Set(ABOX);
  CreateObject(AMCT, 2990, 1200, -1)->Set(ABOX);

  //Versorgungskisten (Gewehrgranaten)
  CreateObject(AMCT, 1150, 940, -1)->Set(GBOX);
  CreateObject(AMCT, 2140, 940, -1)->Set(GBOX);

  //Versorgungskisten (Raketen)
  CreateObject(AMCT, 545, 1172, -1)->Set(MBOX);
  CreateObject(AMCT, 2990, 800, -1)->Set(MBOX);

  //Versorgungskiste (APW)
  CreateObject(AMCT, 2960, 800, -1)->Set(ATWN);

  //Versorgungskiste (Dragnin)
  CreateObject(AMCT, 3500, 920, -1)->Set(DGNN);
...
func CreateDecoration()
{
  ...
  CreateObject(FLGH, 4130, 1000, -1)->SetRotation(-80);
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    //Hinweisschilder
    CreateObject(SGNP, 780, 1160, -1)->Set("Turret");
    CreateObject(SGNP, 2885, 960, -1)->Set("Turret",1);
    CreateObject(SGNP, 3070, 800, -1)->Set("Turret",1);
    CreateObject(SGNP, 3575, 1040, -1)->Set("Turret",1);
    ...
    if(!FindObject(NOHC))
    {
      ...
      CreateObject(SGNP, 800, 720, -1)->Set("Helicopter");
      CreateObject(SNPT, 1160,850, -1)->SetAction("Sign3");
      CreateObject(SGNP, 1310, 820, -1)->Set("Helicopter");
    }
  ...
  if(FindObject(GASS))
  {
    ...
    //Versorgungskiste (APW)
    CreateObject(AMCT, 3860, 1040, -1)->Set(ATWN);
    ...
    //Patrouillenboote
    SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1030,1229,-1),50*21);
    SetupVehicleSpawn([PBOT],DIR_Right,CreateObject(VSPW,1150,1229,-1),50*21);
    SetupVehicleSpawn([PBOT],DIR_Left,CreateObject(VSPW,2550,1229,-1),50*21);
  }
  else
  {
    ...
    if(!FindObject(NOAM))
    {
      ...
      CreateObject(AMCT, 3490, 1180, -1)->Set(GBOX);
    }
  }
