...
func Initialize()
{
  ...
  if(C4X_VerBuild < 331) {SetNextMission("ModernCombat.c4f\\CMC_BabelTower.c4s", "$RepeatButton$", "$RepeatButtonDesc$");}
  return 1;
}
...
func CreateEquipment()
{
  ...
  CreateObject(AMCT, 1155, 441, -1)->Set(ABOX);
  CreateObject(AMCT, 740, 1740, -1)->Set(ABOX);

  //Versorgungskisten (Gewehrgranaten)
  CreateObject(AMCT, 1215, 441, -1)->Set(GBOX);
  CreateObject(AMCT, 1620, 1740, -1)->Set(GBOX);

  //Versorgungskisten (APW)
  aTowerInterior[7] = CreateObject(AMCT, 1185, 392, -1);
  aTowerInterior[7] -> Set(ATWN);
  CreateObject(AMCT, 1075, 1120, -1)->Set(ATWN);
...
func CreateDecoration()
{
  ...
  CreateObject(FLGH, 885, 472, -1)->Set(0,0,1,65);
  CreateObject(FLGH, 1485, 472, -1)->Set(0,0,1,-65);
  CreateObject(FLGH, 620, 2192, -1)->Set(0,0,1,-50);
  CreateObject(FLGH, 1745, 2192, -1)->Set(0,0,1,50);
  ...
  //Schilder
  CreateObject(WLSN, 1040, 800, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 1330, 800, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 860, 910, -1)->Set("Heights");
  CreateObject(WLSN, 1520, 910, -1)->Set("Heights");
  CreateObject(WLSN, 1090, 1230, -1)->Set("Extinguisher","Red");
  CreateObject(WLSN, 1280, 1230, -1)->Set("Extinguisher","Red");
...
public func ChooserFinished()
{
  ...
  if(FindObject(GOCC))
  {
    ...
    //Alarmleuchten
    AddGOCCWarnEffect(CreateObject(ALGH, 1090, 320, -1),aFlag[0]);
    AddGOCCWarnEffect(CreateObject(ALGH, 1280, 320, -1),aFlag[0]);

    AddGOCCWarnEffect(CreateObject(ALGH, 985, 700, -1),aFlag[1]);
    AddGOCCWarnEffect(CreateObject(ALGH, 1385, 700, -1),aFlag[1]);

    AddGOCCWarnEffect(CreateObject(ALGH, 1105, 1280, -1),aFlag[2],90);
    AddGOCCWarnEffect(CreateObject(ALGH, 1265, 1280, -1),aFlag[2],-90);

    AddGOCCWarnEffect(CreateObject(ALGH, 1125, 1505, -1),aFlag[3],90);
    AddGOCCWarnEffect(CreateObject(ALGH, 1245, 1505, -1),aFlag[3],-90);

    AddGOCCWarnEffect(CreateObject(ALGH, 1090, 1889, -1),aFlag[4],-180);
    AddGOCCWarnEffect(CreateObject(ALGH, 1280, 1889, -1),aFlag[4],-180);
    ...
    if(!FindObject(NOBH))
    {
      ...
      CreateObject(SGNP, 720, 1940, -1)->Set("Helicopter",1);
      CreateObject(SGNP, 1650, 1940, -1)->Set("Helicopter",1);
    }
  }
